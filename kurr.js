...
const dtod = "6283876159184@s.whatsapp.net"
const otod = "6283876159184@s.whatsapp.net"
// STICKER WM
...
const antilinkgrup = JSON.parse(fs.readFileSync('./database/antilinkgc.json'))
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© ZeniX404_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Hhd9n6n1vFG3AiY8B5vzIe', "groupName": `${NamaBot}`, "footerText": "*_© ZeniX404_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const kuntol = fs.readFileSync('./logo.jpeg')
...
media = file1
kma = doc1
mhan = await kurr.prepareMessage(from, media, document, kma)
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply = (teks) => {
			kurr.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"DON'T CLICK HERE",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/6283876159184`}}})
		}
...
if(budy.includes('pki')){
            gifnya = await getBuffer('https://telegra.ph/file/d24b5b5f04a5271f5cca2.mp4')
		anu =`Bakso Bakso
`
await kurr.sendMessage(from, gifnya, MessageType.video, {mimetype : 'video/gif', quoted: ftrol, thumbnail: gifnya})
}
if(budy.includes('Zenix')){
cpref = `Hayo Ngomongin ZeniX Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
if(budy.includes('Babi')){
cpref = `Hayo Ngomongin Aldi Jelek Yaaa Aowkowkwoo`
reply(cpref)
}
           if (budy.startsWith('>')){
    ...
    if (isGroup && isAntivirtex && !mek.key.fromMe) {
      if (budy.length > 2500) {
        ...
        if (budy.includes("https://","http://")) {
			...
			ano = fs.readFileSync('./sticker/anime/antilink.webp')
			kurr.sendMessage(from, ano, sticker, { quoted: mek})
				}
				
		         if (budy.includes("chat.whatsapp.com/","http://chat.whatsapp.com/")) {
        	if (!mek.key.fromMe){
				if (!isGroup) return
				...
				kurr.updatePresence(from, Presence.composing)
				var kic = `${sender.split("@")[0]}@s.whatsapp.net`
				reply('Link Grup terdeteksi, Auto kick!')
			    kurr.groupRemove(from, [kic]).catch((e) => { sticNotAdmin(from) })
			}
			}
			if (!m.key.fromMe && bad.includes(messagesD)) {
			ano = fs.readFileSync('./sticker/anime/antilinkgrup.webp')
			kurr.sendMessage(from, ano, sticker, { quoted: mek})
				}
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© ZeniX404_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/kurrsadboy')
}
if(isButton == 'ytm'){
reply('http://youtube.com/c/Zak06CHEAT')
}
...
*⃝OWNER: ${NamaOwner}*
*⃝NOMER OWNER: ${NomorOwner}*
*⃝Lib: Baileys*
*⃝speed bot: ${latensyi.toFixed(4)} Second*
*⃝prefix : Multi Prefix* 
*⃝runtime : ${waktu(runtime)}* 
...
⃝ ${prefix}wibu
⃝ ${prefix}puki
⃝ ${prefix}pantexpantek
│
─❒ OWNER
⃝ ${prefix}autorespon [ _on/off_ ]
⃝ ${prefix}bc [ _teks/reply gif/image/video with caption_ ]
⃝ ${prefix}tobc [ _reply sticker/audio with caption_ ]
⃝ ${prefix}return [ _javascript_ ]
⃝ ${prefix}clearall
⃝ ${prefix}delchat
⃝ ${prefix}mute
⃝ ${prefix}unmute
⃝ ${prefix}public
⃝ ${prefix}self
⃝ ${prefix}spam [ _teks|jumlah_ ]
⃝ ${prefix}addcmd [ _teks reply stc_ ]
⃝ ${prefix}delcmd [ _reply stc_ ]
⃝ ${prefix}listcmd
⃝ ${prefix}spamsw [ _teks|jumlah_ ]
⃝ ${prefix}upswteks [ _teks_ ]
⃝ ${prefix}upswlokasi [ _teks_ ]
⃝ ${prefix}upswaudio [ _reply audio_ ]
⃝ ${prefix}upswvoice [ _reply audio_ ]
⃝ ${prefix}upswsticker [ _reply sticker_ ]
⃝ ${prefix}upswimage [ _reply image with caption_ ]
⃝ ${prefix}upswgif [ _reply gif with caption_ ]
⃝ ${prefix}upswvideo [ _reply video with caption_ ]
⃝ ${prefix}shutdown
⃝ ${prefix}offline [ _alasan_ ]
⃝ ${prefix}online
⃝ ${prefix}exif [ _nama|author_ ]
⃝ ${prefix}setprofile [ _reply image_ ]
⃝ ${prefix}setname [ _teks_ ]
⃝ ${prefix}setprefix [ _multi/nopref/prefix_ ]
⃝ ${prefix}setbio [ _teks_ ]
⃝ ${prefix}leave
⃝ ${prefix}restart
⃝ ${prefix}addrespon [ _tanya|jawab_ ]
⃝ ${prefix}delrespon [ _nama_ ]
⃝ ${prefix}listrespon
⃝ ${prefix}readall
⃝ ${prefix}unreadall
⃝ ${prefix}archive
⃝ ${prefix}unarchiveall
⃝ ${prefix}pin
⃝ ${prefix}unpin
⃝ ${prefix}setmenu [ _ori/simpel_ ]
⃝ ${prefix}setallmenu [ _ori/simpel_ ]
⃝ ${prefix}leavetime [ _detik/menit/jam_ ]
⃝ ${prefix}bukatime [ _detik/menit/jam_ ]
⃝ ${prefix}tutuptime [ _detik/menit/jam_ ]
⃝ ${prefix}nano [ _nama file_ ]
│
─❒GAME MENU
...
⃝ ${prefix}pinterest
⃝ ${prefix}herolist
⃝ ${prefix}herodetail [ _hero_ ]
⃝ ${prefix}google [ _search_ ]
⃝ ${prefix}gimage [ _search_ ]
⃝ ${prefix}wiki [ _search_ ]
⃝ ${prefix}mediafire [ _link_ ]
⃝ ${prefix}ytsearch [ _judul_ ]
⃝ ${prefix}ytmp4 [ _link yt_ ]
⃝ ${prefix}ytmp3 [ _link yt_ ]
⃝ ${prefix}play [ _judul lagu_ ]
⃝ ${prefix}video [ _judul video_ ]
⃝ ${prefix}tinyurl [ _link_ ]
⃝ ${prefix}fetch [ _link_ ]
⃝ ${prefix}igdl [ _link_ ]
⃝ ${prefix}tiktokdl [ _link_ ]
⃝ ${prefix}pinterest [ _search_ ]
⃝ ${prefix}lirik [ _judul_ ]
⃝ ${prefix}tourl [ _reply image/video_ ]
⃝ ${prefix}resepmasakan [ _judul_ ]
⃝ ${prefix}artimimpi [ _teks_ ]
⃝ ${prefix}bilangangka [ _angka_ ]
⃝ ${prefix}kalkulator [ _angka_ ]
⃝ ${prefix}fancytext [ _teks_ ]
⃝ ${prefix}githubstalk [ _username_ ]
⃝ ${prefix}translate [ _teks kodebhs_ ]
⃝ ${prefix}ss [ _link_ ]
⃝ ${prefix}playstore [ _search_ ]
⃝ ${prefix}tiktokaudio [ _link_ ]
⃝ ${prefix}brainly [ _search_ ]
⃝ ${prefix}igstory [ _search_ ]
⃝ ${prefix}igstalk [ _link_ ]
⃝ ${prefix}twitter [ _link_ ]
⃝ ${prefix}twmp3 [ _link_ ]
⃝ ${prefix}linkwa [ _search_ ]
⃝ ${prefix}fb [ _link_ ]
⃝ ${prefix}chara [ _search_ ]
⃝ ${prefix}otaku [ _search_ ]
⃝ ${prefix}komiku [ _search_ ]
│
─❒ MAKER
⃝ ${prefix}blackpink
⃝ ${prefix}neon
...
⃝ ${prefix}freefire
⃝ ${prefix}foliokanan [ _text_ ]
⃝ ${prefix}foliokiri [ _text_ ]
⃝ ${prefix}nuliskanan [ _text_ ]
⃝ ${prefix}nuliskiri [ _text_ ]
⃝ ${prefix}maker3d [ _text_ ]
⃝ ${prefix}maker2d [ _text_ ]
⃝ ${prefix}epepserti [ _text_ ]
│
──❒ GROUP
⃝ ${prefix}getpict [ _@tag_ ]
⃝ ${prefix}getname [ _reply target_ ]
⃝ ${prefix}getbio [ _reply target_ ]
⃝ ${prefix}antilink [ _on/off_ ]
⃝ ${prefix}antivirtex [ _on/off_ ]
⃝ ${prefix}antiwame [ _on/off_ ]
⃝ ${prefix} welcome [ _on/off_ ]
⃝ ${prefix}creategrup [ _nama|@tag_ ]
⃝ ${prefix}tictactoe [ _@tag_ ]
⃝ ${prefix}delttt
⃝ ${prefix}kick
⃝ ${prefix}add
⃝ ${prefix}setgrupname
⃝ ${prefix}getpp
⃝ ${prefix}antiwame
⃝ ${prefix}getdeskgc
⃝ ${prefix}sider [ _reply pesan bot_ ]
⃝ ${prefix}hacked [ _teks_ ]
⃝ ${prefix}setnamegc [ _teks_ ]
⃝ ${prefix}setdeskgc [ _teks_ ]
⃝ ${prefix}fitnah [ _@tag|teks1|teks2_ ]
⃝ ${prefix}kontak [ _@tag|nama_ ]
⃝ ${prefix}kontag [ _@tag|nama_ ]
⃝ ${prefix}opengc
⃝ ${prefix}closegc
⃝ ${prefix}resetlinkgc
⃝ ${prefix}linkgrup
⃝ ${prefix}hidetag [ _teks_ ]
⃝ ${prefix}sticktag [ _nama sticker_ ]
⃝ ${prefix}totag [ _reply media_ ]
│
─❒ TOOLS
⃝ ${prefix}sticker
⃝ ${prefix}stickerwm [ _nama|author_ ]
⃝ ${prefix}dadu
⃝ ${prefix}semoji [ _emoji_ ]
⃝ ${prefix}attp [ _teks_ ]
⃝ ${prefix}ttp [ _teks_ ]
⃝ ${prefix}ttp2 [ _teks_ ]
⃝ ${prefix}ttp3 [ _teks_ ]
⃝ ${prefix}ttp4 [ _teks_ ]
⃝ ${prefix}toimg
⃝ ${prefix}tomp3 [ _reply video_ ]
⃝ ${prefix}tomp4 [ _reply sticker gif_ ]
⃝ ${prefix}robot [ _reply audio_ ]
⃝ ${prefix}balik [ _reply audio_ ]
⃝ ${prefix}bass [ _reply audio_ ]
⃝ ${prefix}gemuk [ _reply audio_ ]
⃝ ${prefix}detikvn [ _reply audio caption angka_ ]
⃝ ${prefix}detikvideo [ _reply video caption angka_ ]
│
│
─❒ STORAGE
⃝ ${prefix}listimage
⃝ ${prefix}liststicker
⃝ ${prefix}listvn
⃝ ${prefix}addsticker [ _nama_ ]
⃝ ${prefix}delsticker [ _nama_ ]
⃝ ${prefix}addvn [ _nama_ ]
⃝ ${prefix}delvn [ _nama_ ]
⃝ ${prefix}addimage [ _nama_ ]
⃝ ${prefix}delimage [ _nama_ ]
│
─❒ MENU HARAM
⃝ ${prefix}bokep
⃝ ${prefix}neko
...
⃝ ${prefix}apakah
⃝ ${prefix}bisakah
⃝ ${prefix}caripesan [ _teks|jumlah_ ]
⃝ ${prefix}slots
⃝ ${prefix}suit [ _gunting/batu/kertas_ ]
⃝ ${prefix}tag [ _nomor_ ]
⃝ ${prefix}tagme
⃝ ${prefix}tts [ _kodebhs teks_ ]
⃝ ${prefix}readmore [ _teks1|teks2_ ]
⃝ ${prefix}fitnahpc [ _nomor|teks1|teks2_ ]
⃝ ${prefix}chat [ _nomor|teks_ ]
⃝ ${prefix}fdeface [ _replyimg link|teks1|teks2_ ]
⃝ ${prefix}listgrup
⃝ ${prefix}baileys [ _reply message_ ]
⃝ ${prefix}q [ _reply message_ ]
⃝ ${prefix}getcaption [ _reply message_ ]
⃝ ${prefix}tospam [ _reply audio/sticker/image|jumlah_ ]
⃝ ${prefix}sharelock [ _teks1|teks2_ ]
─❒ SOUND MENU
⃝ ${prefix}sound1 - ⃝ ${prefix}sound75

𝘘𝘜𝘖𝘛𝘌𝘚  : Aku tidak pernah bermimpi tentang kesuksesan. Aku bekerja untuk itu
└─────────────────❒`
sendButLocation(from, `${menu}`, "*_© ZeniX404_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'𝙨𝙩𝙤𝙧𝙚 𝙢𝙚𝙣𝙪'},type:1},{buttonId:`sc`,buttonText:{displayText:'SC'},type:1},{buttonId:`catalog`,buttonText:{displayText:'CATALOG MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
case 'sound1':
      ...
      kurr.sendMessage(from, omkeh, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true })
          break
            ...
            case 'menu':
        ptod = "6283876159184@s.whatsapp.net"
        stod = `${sender}`        
        uwu = '```'
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
tescok = `hello ${pushname}`
Sendbutdocument(from, tescok, `[ *⃝ALL MENU⃝* ]\n
*⃝OWNER: ${NamaOwner}*
*⃝NOMER OWNER: ${NomorOwner}*
*⃝Lib: Baileys*
*⃝speed bot: ${latensyi.toFixed(4)} Second*
...
─❒ SOUND MENU
⃝ ${prefix}sound1 - ⃝ ${prefix}sound75
└─────────────────❒`, fs.readFileSync('./fuck.pdf'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./logo.jpg'), filename:`Zenix.pdf`, pageCount: 99999 }, [{buttonId:`.owner`,buttonText:{displayText:'Owner'},type:1}], {quoted:fvid, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} - ${pushname}\nDownload Script`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/CFOdp0jO0iA`}}})
break
...
*⃝runtime : ${waktu(runtime)}* 
`
sendButLocation(from, `${menu}`, "*_© ZeniX404_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`rules`,buttonText:{displayText:'RULES'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
break
case 'yahaha':
 ss = fs.readFileSync('./sticker/joged.webp')
 msk = fs.readFileSync('./ciahh.mp3')
 kurr.sendMessage(from, ss, MessageType.sticker,{quoted:mek}) 
 await kurr.sendMessage(from, msk, MessageType.Audio,{quoted:mek})
 break
case 'setgrupname':
...
quotes = quotesnya.result.quotes
                nama = ' CATALOG MENU '
       ownerJid = "6283876159184@s.whatsapp.net"
                nomor = 1
                stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
...
const fkontak ={
key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `0@s.whatsapp.net` } : {}) }, message: { 'contactMessage' : { 'displayName': `${pushname}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname}, ;;;\nFN:${pushname}, \nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync('./logo.jpeg')}}}
imeg = await kurr.prepareMessage(from, fs.readFileSync('./logo.jpeg'), 'imageMessage')
imeu = imeg.message.imageMessage
kurr.relayWAMessage(await kurr.prepareMessageFromContent(from, {productMessage: {
businessOwnerJid: '6283876159184@s.whatsapp.net',
product: {
productId: '1011',
productImage:imeu,
title: 'KLIK UNTUK MELIHAT MENU',
description:  `[ *⃝ALL MENU⃝* ]
...
let ler = await kurr.prepareMessage(from, fs.readFileSync('./logo.jpeg'), image)
gbutsan = [
...
contentText:`the fuck`,
footerText: 'Pilih Salah Satu Dibawah ini yah\n_____________________________________',
buttons: gbutsan,
headerType: 1
}
await kurr.sendMessage(from, gbuttonan, MessageType.buttonsMessage, {quoted: ftrol})
break
...
MY GITHUB
[https://github.com/ZakyJunpioon]

MY YOUTUBE
[https://youtube.com/c/Zgans
   `
menu =`KiKo Botz`
gbutsan = [
...
ɢɪᴛʜᴜʙ ᴏᴡɴᴇʀ:https://github.com/ZakyJunpioon
ʸᵒᵘᵗᵘᵇᵉ ᵒʷⁿᵉʳ:https://youtube.com/c/Zgans`
sendButLocation(from, `${menu}`, "*_© ZeniX404_*", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
// BIAR GAK LUPA 
//LUPA
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
            ...
            break
            case 'kentut':
            gifnya = await getBuffer('https://telegra.ph/file/d388998d9366f631344fd.mp4')
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/ZakyJunpioon"
        },
        "index": 0
      }
    ]
...
case 'chiisaihentai':
              ...
              buttonsMessage = {footerText:'✗✗✗ ZeniX ganteng', imageMessage: imageMsg,
              contentText:`Subrek yt : Zgans`,buttons,headerType:4}
...
case 'bj':
               ...
               buff = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=KurrXd`)
                buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ Zgans', imageMessage: imageMsg,
              contentText:`Subrek yt : Zgans`,buttons,headerType:4}
              prep = await kurr.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              kurr.relayWAMessage(prep)
...
case 'blackpink':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=KurrXd&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Zgans`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                case 'glitch':
...
//
case 'jogedb':
  gifnya = await getBuffer('https://telegra.ph/file/573392ac36285fb780f6c.mp4')
		anu =`Joged Joged
`
...
kurr.sendMessage(from, {url: `${pint[Math.floor(Math.random() * pint.length)]}`}, image, {quoted: mek, thumbnail: Buffer.alloc(0), caption: "Subscribe Zgans"})
break
case 'isbaileys': 
case 'bail': 
case 'baileys':
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					if ( args.length === 1 ){
						...
						translate(tekss, {kurr: 'gtx', to:args[0]})
						.then((res) =>{
							reply(res.text)
							}) 
						} else
...
break
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					var teks = body.slice(13)
					anu = await fetchJson(`https://api-alphabot.herokuapp.com/api/stalking/github?username=${teks}&apikey=Alphabot`, {method: 'get'})
					...
					case 'infogempa':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					anu = await fetchJson(`https://xinzbot-api.herokuapp.com/api/infogempa?apikey=XinzBot`, {method: 'get'})
...
if (Number(oi2) >= 50) return reply('Kebanyakan!')
	...
	sendMediaURL(from, `https://api-alphabot.herokuapp.com/api/textpro/halloween?text=${arg}&apikey=Alphabot`)
   break
   case 'vampire':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
   ...
   sendMediaURL(from, `https://api-alphabot.herokuapp.com/api/textpro/carbon?text=${arg}&apikey=Alphabot`)
   break
case 'matrix':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
await kurr.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftrol})
			...
			if (!isBotGroupAdmins) return sticNotAdmin(from)
					if (args[0] === 'on') {
						if (isAntiLinkGrup) return reply('Sudah Aktif Kak')
						antilinkgrup.push(from)
						fs.writeFileSync('./database/antilinkgc.json', JSON.stringify(antilink))
						reply('Sukses mengaktifkan fitur antilinkgrup')
						kurr.sendMessage(from, `ALLERT!!! Group ini sudah di pasang anti link group\nJika Kamu Melanggar Maka Akan Saya Tendang`, text)
					} else if (args[0] === 'off') {
						if (!isAntiLink) return reply('Sudah Mati Kak')
						var ini = antilink.indexOf(from)
						antilink.splice(ini, 1)
						fs.writeFileSync('./database/antilinkgc.json', JSON.stringify(antilink))
						reply('Sukses menonaktifkan fitur antilinkgrup')
					} else if (!c){
 anu =`Silahkan pilih salah satu\n\non: untuk mengaktifkan\noff: untuk menonaktifkan`
punten = [{buttonId: 'antilinkgrup off', buttonText: {displayText: 'OFF✖️'}, type: 1},{buttonId: 'antilinkgrup on', buttonText: {displayText: 'ON✔️'}, type: 1}]
const btnasu = {
    contentText: `${anu}`,
    footerText: '*_©kurr_*',
    buttons: punten,
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer ${NamaBot}",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpeg'),sourceUrl:"https://wa.me/p/6349482305092740/6283876159184"}}})
	}
    }
    }
    }
